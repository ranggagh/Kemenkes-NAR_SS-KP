...
<div id="layoutSidenav_content">
    <main>
        <div class="container-fluid px-4" style="margin-left:0px; margin-top:-25px;">
            ...
            <div class="row mt-4">
                <div class="col-sm-9 offset-sm-3 d-flex justify-content-center" style="margin-left:100px;">
                    <a href="index.php?page=laporan" class="btn btn-primary me-2" style="padding: 7px 20px;">Kembali</a>
                    <button onclick="printDocument()" class="btn btn-secondary" style="padding: 7px 20px;">Print</button>
                </div>
            </div>
            <script>
