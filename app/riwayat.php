                ...
                <table class="table table-hover" id="#tabel1">
                    ...
                    <tbody>
                        ...
                        while ($row = mysqli_fetch_assoc($result)) {
                            ...
                            echo "<a href='index.php?page=detail-riwayat&nik=" . $row['nik'] . "' class='btn btn-sm btn-primary' title='Detail Riwayat'><i class='fa fa-eye'></i></a>";

                            echo "<a href='delete_pasien.php?nik=" . $row['nik'] . "' class='btn btn-sm btn-danger' title='Delete Data Riwayat' onclick='return confirm(\"Apakah anda yakin ingin menghapus data ini?\")' style='margin-left: 10px;'><i class='fa fa-trash'></i></a>";
                            echo "</div>";
